...
import { getTokenFromCookie } from "@/utils/api"; // ✅ Import API functions
  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-5  lg:items-center xl:justify-between ease-out duration-200 ${
            stickyMenu ? "py-4" : "py-6"
          }`}
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto mx-auto flex-col sm:flex-row w-full  flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            {/* pizda */}
            <Link className="flex-shrink-0 justify-start" href="/">
              <Image
                src="/images/logo/oyudentLogo.png"
                alt="Logo"
                width={100}
                height={36}
              />
            ...
            <nav>
                <ul className="flex mx-auto xl:items-center flex-col xl:flex-row gap-3 xl:gap-6">
